        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-gray-400 mb-4">
              The easiest way to sell your unused software licenses and maximize your return.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Software Guide</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">License FAQs</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white text-sm">Legal Terms</a></li>
